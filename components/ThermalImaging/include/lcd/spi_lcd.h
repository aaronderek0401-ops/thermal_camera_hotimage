...
#define LCD_PIXEL_SIZE_240_240     1     // 1.54寸 240*240 ST7789方屏
 ...
 */
#define LCD_DIR horizontal // vertical、horizontal。竖屏 / 横屏 (240x240方屏使用竖屏模式)
...
#define LCD_PIN_NUM_BCKL CONFIG_LCD_IONUM_BCKL // 背光PWM引脚。0-关闭，1-打开

#ifdef CONFIG_LCD_HSPI
#define LCD_SPI_SLOT SPI2_HOST // hspi
#elif CONFIG_LCD_VSPI
#define LCD_SPI_SLOT SPI3_HOST // vspi
#else
#define LCD_SPI_SLOT SPI3_HOST // default to SPI3
#endif
...
#define LCD_DEF_DMA_CHAN SPI_DMA_CH_AUTO // LCD默认使用的SPI-DMA通道（自动选择）
